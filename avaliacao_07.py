...
def menu_avaliacao(df):
    ...
    while True:
        ...
        if op == '0': break
            ...
            nome_arquivo = "FD00x_predicoes.txt"
...
if __name__ == "__main__":
    ...
    _, _, X_test_cnn = preparar_dados_redes_neurais(seq_len=30)
    ...
    model_cnn = tf.keras.models.load_model('FD00x_cnn.keras', compile=False)
    model_cnn.compile(optimizer=tf.keras.optimizers.legacy.Adam(learning_rate=0.001), loss='mse')
    
    model_rf = joblib.load('FD00x_rf.joblib')
